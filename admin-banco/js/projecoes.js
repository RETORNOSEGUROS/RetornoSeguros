...
// Versão 2.0 - Com Checklist por Ramo e Prazos
// ================================================================================

console.log("=== Projecoes.js v2.0 carregado ===");
...
// Configuração dos ramos baseada na collection ramos-seguro
const RAMOS_CONFIG = {
  'saude-funcionarios': {
    id: 'saude-funcionarios',
    nome: 'Saúde Funcionários',
    icon: '🏥',
    cor: '#ef4444',
    ticketMedio: 400,
    unidade: 'vida',
    campoAuto: 'funcionariosQtd',
    visitaStatus: 'saude',
    checklist: [
      { id: 1, texto: 'Tem ou não tem seguro', auto: true, prazo: 5, fonte: 'visita' },
      { id: 2, texto: 'Planilha com data nascimento funcionários', auto: false, prazo: 8 },
      { id: 3, texto: 'Cotação enviada por e-mail', auto: false, prazo: 12 },
      { id: 4, texto: 'Confirmação recebimento - cliente ciente', auto: false, prazo: 18 },
      { id: 5, texto: 'FECHADO', auto: false, prazo: 25, final: true }
    ]
  },
  'saude-socios': {
    id: 'saude-socios',
    ...
    checklist: [
      { id: 1, texto: 'Tem ou não tem seguro', auto: true, prazo: 5, fonte: 'visita' },
      { id: 2, texto: 'Planilha com data nascimento sócios', auto: false, prazo: 8 },
      { id: 3, texto: 'Cotação enviada por e-mail', auto: false, prazo: 12 },
      { id: 4, texto: 'Confirmação recebimento - cliente ciente', auto: false, prazo: 18 },
      { id: 5, texto: 'FECHADO', auto: false, prazo: 25, final: true }
    ]
  ...
  'dental-funcionarios': {
    ...
    visitaStatus: 'dental',
    checklist: [
      { id: 1, texto: 'Funcionários mapeados', auto: true, prazo: 5, fonte: 'funcionarios' },
      { id: 2, texto: 'Cotação enviada ao cliente', auto: false, prazo: 10 },
      { id: 3, texto: 'Tentativa agenda corretor com RH/decisor', auto: false, prazo: 15 },
      { id: 4, texto: 'Contato agência - saber se há interesse', auto: false, prazo: 20 },
      { id: 5, texto: 'FECHADO', auto: false, prazo: 25, final: true }
    ]
  },
  'dental-socios': {
    ...
    visitaStatus: 'dental',
    checklist: [
      { id: 1, texto: 'Sócios identificados', auto: false, prazo: 5 },
      { id: 2, texto: 'Cotação enviada', auto: false, prazo: 10 },
      { id: 3, texto: 'Tentativa de agenda', auto: false, prazo: 15 },
      { id: 4, texto: 'Confirmação interesse', auto: false, prazo: 20 },
      { id: 5, texto: 'FECHADO', auto: false, prazo: 25, final: true }
    ]
  },
  'vida-global-funcionarios': {
    id: 'vida-global-funcionarios',
    nome: 'Vida Funcionários',
    icon: '👥',
    cor: '#8b5cf6',
    ticketMedio: 25,
    unidade: 'vida',
    campoAuto: 'funcionariosQtd',
    visitaStatus: 'vida-global',
    checklist: [
      { id: 1, texto: 'Funcionários mapeados', auto: true, prazo: 5, fonte: 'funcionarios' },
      { id: 2, texto: 'Cotação enviada ao cliente', auto: false, prazo: 12 },
      { id: 3, texto: 'Confirmação recebimento - cliente ciente', auto: false, prazo: 18 },
      { id: 4, texto: 'FECHADO', auto: false, prazo: 25, final: true }
    ]
  },
  'pessoa-chave': {
    id: 'pessoa-chave',
    nome: 'Vida Sócios / Pessoa Chave',
    icon: '👔',
    cor: '#a855f7',
    ticketMedio: 150,
    unidade: 'apólice',
    visitaStatus: 'vida',
    checklist: [
      { id: 1, texto: 'Envio CNPJ, nascimento, %, cotas e último PL', auto: false, prazo: 5 },
      { id: 2, texto: 'Cotação enviada para o cliente', auto: false, prazo: 12 },
      { id: 3, texto: 'Confirmação recebimento - cliente ciente', auto: false, prazo: 18 },
      { id: 4, texto: 'FECHADO', auto: false, prazo: 25, final: true }
    ]
  },
  'frota': {
    ...
    visitaStatus: 'frota',
    checklist: [
      { id: 1, texto: 'Vencimento e prêmio mapeados', auto: true, prazo: 5, fonte: 'visita' },
      { id: 2, texto: 'Planilha da frota com dados veículos', auto: false, prazo: 8 },
      { id: 3, texto: 'Envio da apólice atual', auto: false, prazo: 12 },
      { id: 4, texto: 'Cotação enviada no mês vencimento', auto: false, prazo: 18 },
      { id: 5, texto: 'Confirmação recebimento - cliente ciente', auto: false, prazo: 22 },
      { id: 6, texto: 'FECHADO', auto: false, prazo: 25, final: true }
    ]
  },
  'empresarial-patrimonial': {
    id: 'empresarial-patrimonial',
    nome: 'Patrimonial',
    icon: '🏢',
    cor: '#10b981',
    ticketMedio: 5000,
    unidade: 'apólice',
    visitaStatus: 'patrimonial',
    checklist: [
      { id: 1, texto: 'Vencimento e prêmio mapeados', auto: true, prazo: 5, fonte: 'visita' },
      { id: 2, texto: 'Envio da apólice atual', auto: false, prazo: 10 },
      { id: 3, texto: 'Cotação enviada no mês vencimento', auto: false, prazo: 18 },
      { id: 4, texto: 'Confirmação recebimento - cliente ciente', auto: false, prazo: 22 },
      { id: 5, texto: 'FECHADO', auto: false, prazo: 25, final: true }
    ]
  },
  'equipamentos': {
    ...
    ticketMedio: 3000,
    unidade: 'apólice',
    visitaStatus: 'equipamentos',
    checklist: [
      { id: 1, texto: 'Vencimento e prêmio mapeados', auto: true, prazo: 5, fonte: 'visita' },
      { id: 2, texto: 'Lista de equipamentos obtida', auto: false, prazo: 10 },
      { id: 3, texto: 'Cotação enviada', auto: false, prazo: 18 },
      { id: 4, texto: 'Confirmação recebimento', auto: false, prazo: 22 },
      { id: 5, texto: 'FECHADO', auto: false, prazo: 25, final: true }
    ]
  },
  'garantia': {
    ...
    ticketMedio: 15000,
    unidade: 'contrato',
    visitaStatus: 'garantia',
    checklist: [
      { id: 1, texto: 'Necessidade identificada', auto: false, prazo: 5 },
      { id: 2, texto: 'Documentação licitação/contrato', auto: false, prazo: 10 },
      { id: 3, texto: 'Cotação enviada', auto: false, prazo: 15 },
      { id: 4, texto: 'Confirmação recebimento', auto: false, prazo: 20 },
      { id: 5, texto: 'FECHADO', auto: false, prazo: 25, final: true }
    ]
  },
  'transporte': {
    ...
    ticketMedio: 2000,
    unidade: 'embarque',
    visitaStatus: 'transporte',
    checklist: [
      { id: 1, texto: 'Necessidade mapeada', auto: false, prazo: 5 },
      { id: 2, texto: 'Cotação enviada', auto: false, prazo: 12 },
      { id: 3, texto: 'Confirmação interesse', auto: false, prazo: 18 },
      { id: 4, texto: 'FECHADO', auto: false, prazo: 25, final: true }
    ]
  },
  'rc': {
    ...
    checklist: [
      { id: 1, texto: 'Necessidade identificada', auto: false, prazo: 5 },
      { id: 2, texto: 'Questionário preenchido', auto: false, prazo: 10 },
      { id: 3, texto: 'Cotação enviada', auto: false, prazo: 15 },
      { id: 4, texto: 'Confirmação recebimento', auto: false, prazo: 20 },
      { id: 5, texto: 'FECHADO', auto: false, prazo: 25, final: true }
    ]
...
async function initSistema() {
  ...
  $('selAgencia').addEventListener('change', async () => {
    ...
    await Promise.all([carregarEmpresas(), carregarGerentes(), carregarPlanejamento()]);
  });
...
async function carregarEmpresas() {
  ...
  try {
    ...
    console.log("[Empresas]", CACHE.empresas.length);
...
async function carregarVisitas() {
  ...
  console.log("[Visitas]", Object.keys(CACHE.visitas).length);
}
...
async function carregarGerentes() {
  ...
  try {
    ...
    preencherFiltros();
    console.log("[Gerentes]", CACHE.gerentes.length);
...
async function carregarPlanejamento() {
  if (!ESTADO.agenciaId) return;
  try {
    const snap = await db.collection('projecoes').where('agenciaId', '==', ESTADO.agenciaId).where('ano', '==', ESTADO.ano).limit(1).get();
    if (!snap.empty) {
      const doc = snap.docs[0];
      const data = doc.data();
      ESTADO.planejamentoId = doc.id;
      ESTADO.ramosSelecionados = data.ramosSelecionados || [];
      ESTADO.metas = data.metas || {};
      ESTADO.qtdGerentes = data.qtdGerentes || 4;
      $('qtdGerentes').value = ESTADO.qtdGerentes;
      restaurarSelecoes();
      console.log("[Planejamento carregado]", doc.id);
    } else {
      ESTADO.planejamentoId = null;
    }
  } catch (e) { console.error("[carregarPlanejamento]", e); }
}
...
function gerarDistribuicao() {
  ...
  MESES.forEach((mes, idx) => {
    ...
    ESTADO.ramosSelecionados.forEach(ramoId => {
      ...
      if (!ramo || !meta) return;
      html += `<div class="month-ramo"><div class="month-ramo-header"><div class="month-ramo-title"><span>${ramo.icon}</span><span>${ramo.nome}</span></div><div class="month-ramo-meta">Meta: ${toBRLCompact(meta.porGerente)}/ger</div></div><div class="empresas-slots">`;
      for (let i = 1; i <= 3; i++) {
        const slotId = `${idx + 1}-${ramoId}-${i}`;
        html += `<div class="empresa-slot" data-slot="${slotId}" onclick="abrirSeletorEmpresa('${slotId}','${ramoId}')"><div class="slot-number">${i}</div><div class="slot-content"><div class="slot-empresa">Selecionar empresa...</div></div></div>`;
      }
      html += '</div></div>';
    });
    html += '</div></div>';
...
let SLOT_ATUAL = null, RAMO_ATUAL = null, EMP_SELECIONADA = null;

function abrirSeletorEmpresa(slotId, ramoId) {
  SLOT_ATUAL = slotId;
  RAMO_ATUAL = ramoId;
...
function renderizarListaEmpresas(filtro = '') {
  ...
  let lista = CACHE.empresas.filter(e => !filtro || e.nome?.toLowerCase().includes(filtro.toLowerCase())).map(emp => {
    ...
    let potencial = ramo.campoAuto && func > 0 ? func * ramo.ticketMedio * 12 : ramo.ticketMedio * 12;
  ...
  if (lista.length === 0) {
    container.innerHTML = '<div class="empty-state"><p>Nenhuma empresa</p></div>';
    return;
  }
  
  const badges = {
    'nao-possui': '<span class="badge badge-success">Não possui</span>',
    'ativo': '<span class="badge badge-info">Ativo</span>',
    'vence': '<span class="badge badge-warning">Vence</span>',
    'vencido': '<span class="badge badge-danger">Vencido</span>',
    'nao-mapeado': '<span class="badge" style="background:#f1f5f9;color:#64748b">Não mapeado</span>'
  };
  ...
  container.innerHTML = lista.slice(0, 50).map(e => `
    <div class="empresa-option" data-id="${e.id}" onclick="selecionarEmpresaModal('${e.id}')">
      <div style="flex:1">
        ...
        <div style="font-size:12px;color:var(--text-muted)">${e.funcionarios > 0 ? e.funcionarios + ' func. • ' : ''}Potencial: ${toBRLCompact(e.potencial)}/ano</div>
      </div>
      ${badges[e.status] || ''}
    </div>
  `).join('');
...
function confirmarEmpresa() {
  ...
  const ramo = RAMOS_CONFIG[RAMO_ATUAL];
  const func = emp.funcionariosQtd || emp.numFuncionarios || 0;
  const potencial = func > 0 ? func * ramo.ticketMedio * 12 : ramo.ticketMedio * 12;
  
  const slot = document.querySelector(`[data-slot="${SLOT_ATUAL}"]`);
  if (slot) {
    slot.classList.add('filled');
    slot.innerHTML = `<div class="slot-number">✓</div><div class="slot-content"><div class="slot-empresa">${emp.nome}</div><div class="slot-potencial">${toBRLCompact(potencial)}/ano${func > 0 ? ' • ' + func + ' func.' : ''}</div></div>`;
  ...
  CACHE.empresas.forEach(emp => {
    ...
    if (func > 0) {
      ...
      if (status === 'nao-possui' || !status) {
        leadsDental.push({ ...emp, funcionarios: func, potencial: func * 18.5 * 12, status: status || 'nao-mapeado', prioridade: status === 'nao-possui' ? 'high' : 'medium' });
      }
    }
    ...
    if (statusSaude === 'nao-possui' || !statusSaude) {
      leadsSaude.push({ ...emp, funcionarios: func, potencial: func > 0 ? func * 400 * 12 : 3 * 400 * 12, status: statusSaude || 'nao-mapeado', prioridade: statusSaude === 'nao-possui' ? 'high' : 'medium', dica: func === 0 ? 'Mínimo 3 vidas = R$ 14.400/ano' : null });
    }
  });
...
window.exportarDistribuicaoExcel = exportarDistribuicaoExcel;
window.exportarDistribuicaoPDF = exportarDistribuicaoPDF;
